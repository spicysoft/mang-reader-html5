...
<div id="reader_container">
 ...
 <div id="reader_wrapper">
  ...
  <iframe id="reader_reader" src="/local-test/mr/target/dist-debug/ja_pc.html#1925,member,<?=time()?>" width="640" height="640" frameborder="0" allowfullscreen="true" scrolling="no"></iframe>
